...
# test_images, test_labels = U.read_svhn_mat('/content/gdrive/MyDrive/MCMIL/test.mat')
...
# # with open( '/content/gdrive/MyDrive/MCMIL/svhn_model_ks_5_dims_96_128_192', 'rb') as f:
#     Ws = pickle.load(f)
